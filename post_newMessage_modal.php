<?php
	...
	if($_SESSION['username']=="" or $_SESSION['receiver']=="" or $_POST['postmsg1']=="")
	{
		header('Location: message.php');
		exit();
	}
	//mysqli_query($con,"INSERT INTO message (`sender`,`receiver`,`message`) VALUES ('a@a','c@c','loveWorking')");
	mysqli_query($con,"INSERT INTO message (`sender`,`receiver`,`message`) VALUES ('$_SESSION[username]','$_SESSION[receiver]','$_POST[postmsg1]')");
